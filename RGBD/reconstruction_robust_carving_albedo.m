% reconstruction_robust_carving_albedo.m
% Connor Henley, Tomohiro Maeda
% 3/5/2020
%
% Driver script that implements imaging behind occluders algorithm.
% This implementation uses a shadow segmentation method that does not 
% require background frames, and that can be applied when the visible relay 
% surfaces have varying albedo.  The shadow segmentation method is 
% described in the second half of Supplementary Section 2.3.
%
...
illumination_filename = 'laser_exposure1.mat'; % RGB frames from short exposures
...
%% Correct frame intensity by expected irradiance at each pixel
W2_normal = [-1,0,0];
