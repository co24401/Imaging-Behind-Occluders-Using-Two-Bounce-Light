function volume = scatter_plot_threshold_ratio(inside_voxel, outside_voxel, ratio_threshold, inside_threshold, outside_threshold)
    ...
    outside_voxel.volume(outside_voxel.volume ==0) = 1e-3;
    volume = (inside_voxel.volume./outside_voxel.volume) >= ratio_threshold;
    volume = volume .* (inside_voxel.volume >= inside_threshold) .* (outside_voxel.volume <= outside_threshold);
